...
Note: Because the prameter of *choices*, *prompt*, *trial_duration*, and *response_ends_trial* is same as that of the plugins included in the jsPsych, the explanation of these parameters was copied and paseted from the original site.
